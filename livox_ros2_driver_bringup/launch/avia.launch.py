"""Launch one or more Livox Avia sensors with safe defaults."""
...
_LOGGER = get_logger("livox_ros2_driver_bringup.avia")


def _launch_avia(context, *, default_config):
