"""Launch Livox Avia sensors in PointCloud2 mode with safe defaults."""
...
_LOGGER = get_logger("livox_ros2_driver_bringup.avia_pointcloud2")


def _launch_avia_pointcloud2(context, *, default_config):
    ...
    try:
        ...
        raise RuntimeError(f"Avia configuration rejected: {exc}") from exc

    if result.enabled_lidar_count == 0:
        _LOGGER.warning(
            "Avia automatic discovery is active. Use a validated 15-character "
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description="Avia JSON configuration; use an absolute path in production.",
        ),
        DeclareLaunchArgument(
            "publish_freq",
            default_value="10.0",
        ...
        OpaqueFunction(
            function=_launch_avia_pointcloud2,
