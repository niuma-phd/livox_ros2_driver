"""Launch one or more Livox Horizon sensors with safe defaults."""
...
_LOGGER = get_logger("livox_ros2_driver_bringup.horizon")


def _launch_horizon(context, *, default_config):
